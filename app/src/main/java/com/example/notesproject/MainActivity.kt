...
fun FirstScreen(nav: DestinationsNavigator,contactsListViewModel: contactsListViewModel= hiltViewModel(),
    ...
    Row(modifier = Modifier
        ...
        if (contactsListViewModel.contacts.count() > 0){
            LazyColumn(
                modifier = Modifier.padding(0.dp,90.dp,0.dp,20.dp)
            ) {
    ...
    if (openDialog.value) {
        AlertDialog(modifier = Modifier.size(330.dp,238.dp),
            ...
            title = {
                Text(modifier = Modifier
                    ...
                    .padding(10.dp)
                    ,
                    text = "Designed by - Ahmed aljhani\n" +
                            "Redesigned by - \n" +
                            "Illustrations - \n" +
                            "Icons - \n" +
                            "Font -\n",
            ...
            text = {
                Text(modifier = Modifier.fillMaxWidth(), text = "Made By Ahmed aljhani", fontSize = 15.sp, color = Color(0xFFCFCFCF), textAlign = TextAlign.Center)
            },
            buttons = {
...
fun SecondScreen(nav: DestinationsNavigator, addContactViewModel: AddContactViewModel= hiltViewModel()) {
            ...
            AlertDialog(
                ...
                buttons = {
                    Row(
                        ...
                        Button(modifier = Modifier.size(112.dp,39.dp),
                            onClick = {
                                openDialog.value = false
    ...
    if (openDialog2.value) {
        AlertDialog(modifier = Modifier.size(330.dp,236.dp),
            shape = RoundedCornerShape(20.dp),
            backgroundColor = Color(0xFF252525),
            onDismissRequest = {
            ...
            text = {
                Column(modifier = Modifier
                    .fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                    Text(modifier = Modifier.padding(30.dp).fillMaxWidth(), text = "Save changes ?", fontSize = 23.sp, color = Color(0xFFCFCFCF), textAlign = TextAlign.Center,)
            ...
            TextField(
                ...
                trailingIcon = {
                    IconButton(
                        ...
                        Icon(
                            Icons.Default.Close, contentDescription = "Icon", tint = Color(0xFFCCCCCC)
                        )
                    }
                               },
